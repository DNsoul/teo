...
const initBody = [
  ...
  ["Коэф. использования установленной мощности", "0.6"],
  ["Коэффициент накладных расходов", "0.2"],
  ["Районный коэффициент", "0.3"],
  ["Коэф. затрат на материалы", "0.01"],
  ["Норматив затрат на ремонт", "0.05"],
  ["Тариф на электроэнергию, кВт/час", "2.6"],
  ["Норматив среднесуточной загрузки (час/день)", "8"],
  ["Норма годовых отчислений амортизации", "0.2"],
];
